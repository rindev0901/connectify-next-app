        ...
        <FadeIn>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="space-y-4">
              <h3 className="font-display font-bold text-xl">Nextify</h3>
              <p className="text-muted-foreground text-sm">
                The next generation app platform with modern authentication.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/roadmap" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                    Roadmap
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/documentation" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                    Documentation
                  </Link>
                </li>
                <li>
                  <Link to="/support" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                    Support
                  </Link>
                </li>
                <li>
        ...
        <FadeIn delay={200}>
          <div className="border-t border-border/40 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              © {year} Nextify. All rights reserved.
            </p>
