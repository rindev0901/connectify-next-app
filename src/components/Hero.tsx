      ...
      <div className="container mx-auto px-4 py-24 pt-32 md:py-32 md:pt-40 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 text-center lg:text-left">
            ...
            <FadeIn direction="up" delay={200}>
              <p className="text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0">
                Experience the future of web applications with seamless social authentication and cutting-edge features.
              </p>
            </FadeIn>
            ...
            <FadeIn direction="up" delay={300}>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mt-8">
                ...
                >
                  <span className="relative group-hover:text-primary transition-colors">Learn More</span>
                </Button>
              </div>
            </FadeIn>
          ...
          <FadeIn className="relative" delay={200}>
            ...
            <div className="absolute -top-4 -left-4 w-16 h-16 bg-accent/20 rounded-full animate-float" style={{ animationDelay: "1s" }} />
          </FadeIn>
        </div>
      </div>
